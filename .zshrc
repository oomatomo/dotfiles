...
#Custom Command
#
alias app='perl -Ilib ./script/tachyon_website_server.pl -r'
alias appnyt='perl -d:NYTProf -Ilib ./script/tachyon_website_server.pl '
alias applog='ssh omagari.tomohisa@10.0.32.142'
